<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="results.php"><i class="glyphicon glyphicon-stats"></i> <span>Election Results</span></a></li>
      ...
      <li class=""><a href="ballot.php"><i class="fa fa-list-alt"></i> <span>Ballot Preview</span></a></li>
      <li class="header">SETTINGS</li>
      <li class=""><a href="#config" data-toggle="modal"><i class="fa fa-cog"></i> <span>Election Settings</span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
<?php include 'election_settings_modal.php'; ?>